...
def add_items(driver):
    print_with_timestamp("Add items to cart...")
    ...
    print_with_timestamp(
        "6 Items successfully added to cart! Now removing items from cart.")


def remove_items(driver):
    print_with_timestamp("Removing items from the cart...")
    ...
    assert cart_badge is None, "Still existing items in cart."
